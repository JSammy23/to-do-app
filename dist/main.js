...
const task = (0,_javascript_task__WEBPACK_IMPORTED_MODULE_1__["default"])({
    name: 'Mow the yard',
    note: 'Rain expected Thursday',
    dueDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(2023, 0, 26), 'MM/dd/yyyy'),
    completed: false,
    priority: 'normal'
})

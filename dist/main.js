...
const createCard = (task) => {
    ...
    dotsSvg.addEventListener('click', (event) => {
        ...
        ;(0,_handleForms__WEBPACK_IMPORTED_MODULE_1__.openTaskEditForm)(event.target.previousElementSibling.firstChild.textContent)
    })
...
function openTaskEditForm(taskName) {
    ...
    const task = _project__WEBPACK_IMPORTED_MODULE_0__.allTasks.find(task => task.taskName === taskName)
    const taskDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])((task.dueDate), 'yyyy-MM-dd')
